...
func TestDivisionOperation(t *testing.T) {
	type args struct {
		a uint64
		b uint64
	}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, got1 := models.DivisionOperation(tt.args.a, tt.args.b)
			if got != tt.want {
				t.Errorf("DivisionOperation() got = %v, want %v", got, tt.want)
			}
			if got1 != tt.want1 {
				t.Errorf("DivisionOperation() got1 = %v, want %v", got1, tt.want1)
			}
		})
	}
}
...
func TestIntToBytes(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := models.IntToBytes(tt.args.digit); !reflect.DeepEqual(got, tt.want) {
...
func TestImposeError(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := models.ImposeError(tt.args.a, tt.args.e); got != tt.want {
